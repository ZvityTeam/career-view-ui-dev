...
export const data = [
  ...
  {
    name: 'Stuart Mayor',
    role: 'Maritime Logistics Supply Chain Submariner',
    shortDesc:
      'Stuart is Maritime Logistics Supply Chain Submariner at the Australian Navy, managing essential supplies to ensure naval mission readiness.',
    company: 'Australian Navy',
    university: 'N/A',
    bio: 'Stuart is Maritime Logistics Supply Chain Submariner at the Australian Navy, managing essential supplies to ensure naval mission readiness.',
    availableHours: 'N/A',
    profileImage: stuart_mayor,
    hobbies: '',
    interests: '',
    sideHustles: 'None',
    location: 'N/A',
    industries: ['Defence', 'Logistics'],
    questions: [],
    socialLinks: {
      linkedin: '',
      twitter: '',
