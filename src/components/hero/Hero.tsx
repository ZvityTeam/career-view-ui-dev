...
export const Hero = () => {
  return (
    <section className='flex min-h-screen flex-col items-center justify-center gap-52 space-y-32 bg-gradient-to-b from-slate-900 via-slate-800 to-yellow-100 py-16 text-center'>
      {/* Heading */}
