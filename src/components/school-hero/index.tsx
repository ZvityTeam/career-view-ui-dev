...
export const SchoolHero = () => {
  ...
  const getContainerStyles = () => {
    if (isMobile) {
      return {
        className:
          'absolute left-0 top-16 flex h-auto flex-col justify-center gap-3 rounded-br-[6rem] px-6 py-12 text-white backdrop-blur-xl',
      ...
      return {
        className:
          'absolute left-0 top-12 flex h-auto flex-col justify-center gap-4 rounded-br-[6rem] px-12 py-16 text-white backdrop-blur-xl',
