function PrivacyPolicyPage() {
  return (
    <div className='min-h-screen bg-gray-900 p-6 pt-40 text-white'>
      <div className='mx-auto max-w-7xl rounded-lg bg-gray-800 p-6 shadow-lg'>
        ...
        <h2 className='mb-4 mt-6 text-2xl font-semibold text-white'>
          VIRTUAL LEARNING GROUP – PRIVACY POLICY
        </h2>
        <p className='mb-4 text-gray-200'>
          ...
          offline or online, including through our website (Site). In this
          Privacy Policy we, us or our means Virtual Learning Group (ABN 87 376
          752 071).
        </p>
        ...
        <p className='mb-4 text-gray-200'>
          ...
          protect your personal information in a way which is substantially
          similar to the Australian Privacy Principles and/or we will take such
          steps as are reasonable in the circumstances to require that overseas
        ...
        <p className='mb-4 text-gray-200'>
          ...
          racial or ethnic origin, political opinions, religion, trade union or
          other professional associations or memberships, philosophical beliefs,
          sexual orientation or practices, criminal records, health information
          or biometric information.
        </p>
        <p className='mb-4 text-gray-200'>
          We only collect, hold, use and disclose sensitive information for the
          following purposes:
        </p>
        <ul className='mb-4 list-disc space-y-2 pl-5 text-gray-300'>
          ...
          <li>
            ...
            for which it was collected, including disclosure to the above listed
          ...
          <li>
            ...
            or support person where we reasonably believe there is a serious
            risk to the life, health or safety of you or another person and it
            is impracticable for us to obtain your consent; and
          </li>
        ...
        <h3 className='mb-2 mt-4 text-xl font-semibold text-white'>Access</h3>
        <p className='mb-4 text-gray-200'>
          ...
          1988 (Cth), we may refuse to provide you with personal information
        ...
        <p className='mb-4 text-gray-200'>
          If you believe that we have breached the Australian Privacy Principles
        ...
        <p className='mb-4 text-gray-300'>Last update: 8th Oct 2022</p>
      </div>
    </div>
  );
}
