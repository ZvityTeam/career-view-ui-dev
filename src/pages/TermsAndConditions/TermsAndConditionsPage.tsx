function TermsAndConditionsPage() {
  return (
    <div className='pt-40 min-h-screen bg-gray-900 p-6 text-white'>
      <div className='mx-auto max-w-7xl rounded-lg bg-gray-800 p-6 shadow-lg'>
        <h1 className='mb-6 text-3xl font-bold'>Terms of Use</h1>
        <p className='mb-4 text-gray-200'>
          This website (Site) is operated by Virtual Learning Group (ABN 87 376
          752 071) (we, our or us). It is available at:{' '}
          <a
            href='www.careerview.com.au'
            className='text-blue-400 underline hover:text-blue-300'
          >
            www.careerview.com.au
          </a>{' '}
          and may be available through other addresses or channels.
        </p>

        <h2 className='mb-4 mt-6 text-2xl font-semibold text-white'>Consent</h2>
        <p className='mb-4 text-gray-200'>
          By accessing and/or using our Site, you agree to these terms of use
          (Terms) and our Privacy Policy (available on our Site). Please read
          these Terms carefully and immediately cease using our Site if you do
          not agree to them.
        </p>

        <h2 className='mb-4 mt-6 text-2xl font-semibold text-white'>
          Variations
        </h2>
        <p className='mb-4 text-gray-200'>
          ...
          Site regularly to ensure you are aware of our current terms. Materials
          and information on this Site (Content) are subject to change without
          notice. We do not undertake to keep our Site up-to-date and we are not
        ...
        <p className='mb-4 text-gray-200'>
          ...
          non-transferable license to use our Site in accordance with these
        ...
        <p className='mb-4 text-gray-200'>
          ...
          prohibited by any laws applicable to our Site; which we would consider
          inappropriate; or which might bring us or our Site into disrepute,
        ...
        <ul className='mb-4 list-disc space-y-2 pl-5 text-gray-300'>
          ...
          <li>
            ...
            Site, including (without limitation) using trojan horses, viruses or
            piracy or programming routines that may damage or interfere with our
            Site;
          </li>
        ...
        <p className='mb-4 text-gray-200'>
          The Content is not comprehensive and is for general information
          purposes only. It does not take into account your specific needs,
          objectives or circumstances, and it is not advice. While we use
        ...
        <p className='mb-4 text-gray-200'>
          Unless otherwise indicated, we own or license all rights, title and
          interest (including intellectual property rights) in our Site and all
          of the Content. Your use of our Site and your use of and access to any
          Content does not grant or transfer to you any rights, title or
        ...
        <p className='mb-4 text-gray-200'>
          ...
          relevant information and content (User Content) on our Site. By making
          ...
          royalty-free license to use the User Content, with the right to use,
          view, copy, adapt, modify, distribute, license, sell, transfer,
          communicate, publicly display, publicly perform, transmit, stream,
          broadcast, access, or otherwise exploit such User Content on, through
        ...
        <ul className='mb-4 list-disc space-y-2 pl-5 text-gray-300'>
          ...
          <li>
            ...
            User Content on, through or by means of our Site will infringe,
        ...
        <p className='mb-4 text-gray-200'>
          ...
          Unless expressly stated otherwise, we do not control, endorse or
          approve, and are not responsible for, the content on those websites.
          You should make your own investigations with respect to the
        ...
        <p className='mb-4 text-gray-200'>
          We may, at any time and without notice to you, discontinue our Site,
          in whole or in part. We may also exclude any person from using our
          Site, at any time and at our sole discretion. We are not responsible
          for any Liability you may suffer arising from or in connection with
          any such discontinuance or exclusion.
        </p>
        ...
        <p className='mb-4 text-gray-200'>
          To the maximum extent permitted by law, we are not responsible for any
          ...
          connection with your use of our Site and/or the Content and/or any
          inaccessibility of, interruption to or outage of our Site and/or any
          loss or corruption of data and/or the fact that the Content is
        ...
        <p className='mb-4 text-gray-200'>
          ...
          arising from or in connection with your use of our Site or any breach
          of these Terms or any applicable laws by you. This indemnity is a
          continuing obligation, independent from the other obligations under
          these Terms, and continues after these Terms end. It is not necessary
        ...
        <p className='mb-4 text-gray-200'>
          ...
          occurrence of the conference, will be privileged. If the parties do
          not resolve the Dispute, or (if the Dispute is not resolved) agree on
          an alternate method to resolve the Dispute, within 21 days after
          receipt of the notice, the Dispute may be referred by either party (by
          notice in writing to the other party) to litigation.
        </p>
        ...
        <p className='mb-4 text-gray-200'>
          Your use of our Site and these Terms are governed by the laws of the
          state of Western Australia. You irrevocably and unconditionally submit
          to the exclusive jurisdiction of the courts operating in the state of
          Western Australia and any courts entitled to hear appeals from those
          courts and waive any right to object to proceedings being brought in
          those courts.
        </p>
        <p className='mb-4 text-gray-200'>
          ...
          access our Site from outside Australia, you do so at your own risk and
          are responsible for complying with the laws of the jurisdiction where
          you access our Site.
        </p>

        <h2 className='mb-4 mt-6 text-2xl font-semibold text-white'>Contact</h2>
        <p className='mb-4 text-gray-200'>
          For any questions and notices, please contact us at:
        </p>
        <p className='mb-2 text-gray-300'>
          Virtual Learning Group (ABN 87 376 752 071)
        </p>
        <p className='mb-2 text-gray-300'>
          Email:{' '}
          <a
            href='mailto:support@careerview.com.au'
            className='text-blue-400 underline hover:text-blue-300'
          >
            support@careerview.com.au
          </a>
        </p>
        <p className='mb-4 text-gray-300'>Last update: 29th Oct 2022</p>
      </div>
    </div>
  );
}
